...
for example, "glados.cs.rit.edu" and the client files 
may be placed on the local machine.
...
"49152" as follows:
"connect glados.cs.rit.edu 49152" if the 
server program is run on glados.cs.rit.edu.
